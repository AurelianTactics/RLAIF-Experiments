...
def get_trajectory_stats(agent, env, args_dict, experiment_save_dir=None, is_agent_logging=False):
    '''
    ...
    is_agent_logging: bool
        If True call the agent logging script at the end of the sim
    Returns
    -------
    None
    ...
    if is_eval_agent_basic:
        ...
        # if builder had been saved and cleared early this will be incorrect
        df_eval = eval_agent_basic_builder.get_dataframe()
    ...
    if is_log_action_counts:
        ...
        # if the builder had been saved and cleared early this will be incorrect
        df_action = action_builder.get_dataframe()
        ...
        action_dict_counter = None

    if is_agent_logging:
        # internal agent logging
        agent_logging_dict = agent.agent.get_agent_logging()
    else:
        agent_logging_dict = None

    return df_eval, action_dict_counter, agent_logging_dict
